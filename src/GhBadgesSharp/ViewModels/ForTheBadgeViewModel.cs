...
namespace GhBadgesSharp.ViewModels
{
    ...
    internal class ForTheBadgeViewModel : ViewModelBase
    {
        ...
        public ForTheBadgeViewModel(BadgeData badgeData) : base(badgeData, badgeData.LeftText?.ToUpper(), badgeData.RightText?.ToUpper())
        {
            ...
            m_Widths[0] = (m_LeftTextWidth + 10 + LogoWidth + LogoPadding) - (Text[0] != null ? -(10 + ((Text[0]?.Length ?? 0) * 1.5)) : (Logo != null ? (m_BadgeData.ColorA != null ? -7 : 7) : 11));
            ...
            var x1 = ((Widths[0] + LogoWidth + LogoPadding) / 2) * 10;
            ...
            var textWidth1 = (Widths[0] - (24 + LogoWidth + LogoPadding)) * 10;
